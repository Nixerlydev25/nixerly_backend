...
export const getBusinessProfileDetailsSchema = z
  .string()
...
export const businessPagination = z.object({
  skills: z
    .string()
...
export const getBusinessAssetUploadUrl = z.object({
  files: z.array(
    z.object({
      fileName: z.string().min(1, "File name is required"),
...
export const saveBusinessAssets = z.object({
  assets: z.array(
    z.object({
      s3Key: z.string().min(1, "S3 key is required"),
      mediaType: z.string(),
...
export const deleteBusinessAssets = z.object({
